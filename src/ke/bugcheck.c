...
KERNEL_API LPSTR StringifyBugCheckError(KBUGCHECK_REASON BugCheckReason)
{
    ...
    {
    case BUGCHECK_IRQL_LESS_OR_EQUAL:
        return "IRQL_LESS_OR_EQUAL";
    case BUGCHECK_UNEXPECTED_STATE:
        return "UNEXPECTED_STATE";
    case BUGCHECK_UNRECOVERABLE_NO_MEMORY:
        return "UNRECOVERABLE_NO_MEMORY";
    case BUGCHECK_UNEXPECTED_INTERRUPT:
        return "UNEXPECTED_INTERRUPT";
    default:
        return "Unkown bug check reason.";
    }
}
