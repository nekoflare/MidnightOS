...
#define STATUS_ALREADY_MAPPED 12
...
#ifndef __cplusplus
#define CHECK_SIZEOF(type, expected_size) _Static_assert(sizeof(type) == (expected_size), "Size check failed")
#else // __cplusplus
#define CHECK_SIZEOF(type, expected_size) static_assert(sizeof(type) == (expected_size), "Size check failed")
#endif // __cplusplus

#define PREVENT_DOUBLE_INIT                                                                                            \
